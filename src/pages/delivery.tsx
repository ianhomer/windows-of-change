...
export default function Page() {
  const contents = [
    ...
    { left: 300, top: 0, children: "Team Health", opacity: 0.8 },
    {
      left: 500,
      top: 0,
      width: 350,
    ...
    { left: 300, top: 200, children: "resourcing", opacity: 0.6 },
    { left: 500, top: 200, children: "flow / blockages" },
    { left: 700, top: 200, children: "done", opacity: 0.2 },
    { left: 900, top: 200, children: "...", opacity: 0.8 },
